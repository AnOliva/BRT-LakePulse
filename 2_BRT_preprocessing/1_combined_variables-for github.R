...
GIS_combined = read.csv("E:/LakePulse/Data_LakePulse/GIS/combined_GIS_variables.txt", sep=";")
# LULC
LULC = read.csv("E:/LakePulse/Data_LakePulse/GIS/LULC_v2/LakePulse_lulc_simple_qc_v2_20220310.csv", sep=";")
# depth
depth = read.csv("E:/LakePulse/Data_LakePulse/Depth/LakePulse_basic_info_depth_qc_20200901.csv", sep=";")
# optics
a_CDOM = read_excel("E:/LakePulse/Data_LakePulse/Optics/a_CDOM/a_CDOM_LakePulse.xlsx") 
secchi = read.csv("E:/LakePulse/Data_LakePulse/Secchi/LakePulse_secchi_qc_20211223.csv", sep=";") 
TSS_MSPM_OSPM =  read_excel("E:/LakePulse/Data_LakePulse/Optics/TSS/final_3years_data/TSS_withblankcorrection/final/QC_TSS_MSPM_OSPM_2017.2019_update20210407.xlsx", sheet = "QC_TSS_MSPM_OSPM_2017.2019")
# altitude, longitude, latitude, lake area, province, ecozone, ecoprovince, depth
basic_info = read.csv("E:/LakePulse/Data_LakePulse/Basic_infos/LakePulse_basic_info_qc_20220310.csv", sep=";")
# RBR: Wtemp, dissolvedO2, chla, salinity
RBR_Wtemp = read.csv("E:/LakePulse/Data_LakePulse/RBR/LakePulse_rbr_top_bottom_temperature_qc_20201110.csv", sep=";")
RBR_salinity = read.csv("E:/LakePulse/Data_LakePulse/RBR/LakePulse_rbr_top_bottom_salinity_qc_20201110.csv", sep=";")
# chlorophylle filtered
chla_am_pm = read.csv("E:/LakePulse/Data_LakePulse/Optics/Chlrophylle a/LakePulse_chla_qc_20201218.csv", sep=";")
# phosphorus
phosphorus = read.csv("E:/LakePulse/Data_LakePulse/Phosphorus/LakePulse_tp_qc_20201116.csv", sep=";")
nitrogen = read.csv("E:/LakePulse/Data_LakePulse/Nitrogen/LakePulse_tn_qc_20201028.csv", sep=";")
# hydrolakes
hydrolake = read.csv("E:/LakePulse/Data_LakePulse/Hydrolakes/LakePulse_hydrolake_20200901.csv", sep=";")
# ecoumene
ecoumene_lakes = read.csv("E:/LakePulse/Maps/Ecoumene_lakes/ecumenes_lake.csv")
# NOX and SRP
NOX = read.csv("E:/LakePulse/Data_LakePulse/NOX/LakePulse_nox_qc_20210517.csv", sep=";")
SRP = read.csv("E:/LakePulse/Data_LakePulse/SRP/LakePulse_srp_qc_20201124.csv", sep=";")
# geology
#soil = read.csv("E:/LakePulse/Data_LakePulse/Geology/LakePulse_soil_landscape_20220310.csv", sep=";")
#drainage = readxl::read_excel("E:/LakePulse/Data_LakePulse/Geology/calculateSoilLandscapesOfCanadaDRAIN_final20220407.xlsx")
# slope
slope_0_100_m = read.csv("E:/LakePulse/Data_LakePulse/slope_0_100m/slope_0_100_m_LP.csv", sep=";")
...
lakeid <- read.csv("E:/LakePulse/Data_LakePulse/upscaled_dataset/QCed_lakepulse_id_vs_upscaling_idLatLong.csv", sep=";")
